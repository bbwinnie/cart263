window.onload = function () {
    ...
    let garden = {
        ...
        grass: {
            ...
            //the grass element
            grassDiv: this.document.createElement("div"),
        },
    ...
    function createAndRenderTheGarden() {
        ...
        //take the object from the script and add it into html 
        //sky
        garden.sky.skyDiv.classList.add("sky"); // add the sky
        garden.sky.skyDiv.style.background = `rgb(
        ${garden.sky.skyColor.r},
        ${garden.sky.skyColor.g},
        ${garden.sky.skyColor.b}
        )`;
        //put the sky we create into document
    ...
    createAndRenderTheGarden(); // call the function 

    //========object I one flower ===========
    // let first_flower = createFlower();
    // renderFlower(first_flower);

    //========object I flowerstuff===========
    // for (let i = 0; i < garden.numFlowers; i++) {
    //     garden.flowers.push(createFlower()); //push means add to the flower
    // }
    ...
    // }
    //========object I flower class===========
    // for (let i = 0; i < garden.numFlowers; i++) {
    //     let flower = new Flower();
    //     garden.flowers.push(flower); //garden.flowers.push(new flower()); 也可以
    // }
